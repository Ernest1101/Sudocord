...
function VesktopSection() {
    ...
    return (
        <Flex className={Margins.bottom20} flexDirection="column" gap="1em">
            <Card variant="info">
                <HeadingSecondary>Vesktop & SudoCord</HeadingSecondary>
                <Paragraph>Vesktop and SudoCord are two separate things. This updater is for SudoCord.</Paragraph>
    ...
    return (
        <SettingsTab>
            ...
            <FormSwitch
                ...
                description="Automatically update SudoCord without confirmation prompt"
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
            />
            <FormSwitch
                title="Get notified when an automatic update completes"
                description="Show a notification when SudoCord automatically updates"
