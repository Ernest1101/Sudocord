        ...
        >
            {(_, { isShown }) => (
                <HeaderBarIcon
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "SudoCord Toolbox"}
...
export default definePlugin({
    name: "SudoCordToolbox",
    description: "Adds a button to the titlebar that houses SudoCord quick actions",
