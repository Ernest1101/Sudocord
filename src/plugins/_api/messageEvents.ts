    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: (match, args) => "" +
                    `async ${match}` +
                    `if(await SudoCord.Api.MessageEvents._handlePreEdit(${args}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, parsedMessage, channel, options, props) => m +
                    `if(await SudoCord.Api.MessageEvents._handlePreSend(${channel}.id,${parsedMessage},${options},${props}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, message, channel, event) =>
                    `const vcMsg=${message},vcChan=${channel};${m}SudoCord.Api.MessageEvents._handleClick(vcMsg,vcChan,${event});`
            }
        }
    ]
});
