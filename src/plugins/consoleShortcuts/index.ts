...
function makeShortcuts() {
    ...
    return {
        ...
        wpPatcher: { getter: () => SudoCord.WebpackPatcher },
        wpInstances: { getter: () => SudoCord.WebpackPatcher.allWebpackInstances },
        wpsearch: search,
        wpex: extract,
        ...
        PluginsApi: { getter: () => SudoCord.Plugins },
        plugins: { getter: () => SudoCord.Plugins.plugins },
        Settings: { getter: () => SudoCord.Settings },
        Api: { getter: () => SudoCord.Api },
        Util: { getter: () => SudoCord.Util },
        ...
        preEnable: (plugin: string) => (SudoCord.Settings.plugins[plugin] ??= { enabled: true }).enabled = true,
